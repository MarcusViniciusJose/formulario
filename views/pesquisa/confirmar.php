...
<div class="container py-4 px-3">
    ...
    <form method="POST" action="?page=pesquisa&action=salvar" class="w-100">
        ...
        <?php foreach ($respostas as $codigo => $valor): ?>
            <input type="hidden" name="respostas[<?= htmlspecialchars($codigo) ?>]" 
        ...
        <div class="text-center mt-4 d-flex flex-column flex-sm-row justify-content-center gap-2">
            <a href="javascript:history.back()" class="btn btn-secondary flex-fill">Voltar e editar</a>
            <button type="submit" class="btn btn-success flex-fill">Confirmar e enviar</button>
        </div>
